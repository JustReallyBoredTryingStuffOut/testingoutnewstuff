    ...
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}> 
        ...
        <View style={styles.disabledContainer}>
          ...
          <Text style={[styles.disabledTitle, { color: colors.text }]}>Gamification is Disabled</Text>
          <Text style={[styles.disabledMessage, { color: colors.textSecondary }]}>{APP_NAME}'s achievement system is currently disabled. Enable gamification in your profile settings to track achievements, earn points, and level up as you reach your fitness goals.</Text>
          <Button title="Enable Gamification" onPress={() => toggleGamification(true)} style={styles.enableButton} />
          <Button title="Back to Profile" onPress={handleGoBack} variant="outline" style={styles.backButton2} />
        </View>
      </View>
    );
  }
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}> 
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={[styles.statsCard, { backgroundColor: colors.card }]}> 
          ...
          <View style={styles.statItem}>
            <Text style={[styles.statValue, { color: colors.text }]}>{completionPercentage}%</Text>
        ...
        <View style={styles.searchContainer}>
          ...
          <View style={styles.filterContainer}>
            ...
            >
              <Text style={[styles.filterText, { color: showCompleted ? colors.primary : colors.textSecondary }]}>Completed</Text>
            </TouchableOpacity>
            <TouchableOpacity 
              style={[
                styles.filterButton, 
            ...
            >
              <Text style={[styles.filterText, { color: showLocked ? colors.primary : colors.textSecondary }]}>Locked</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.achievementsContainer}>
          <Text style={[styles.sectionTitle, { color: colors.text }]}> {selectedCategory.charAt(0).toUpperCase() + selectedCategory.slice(1)} Achievements{searchQuery ? ` - Search Results` : ''}</Text>
          {filteredAchievements.length === 0 ? (
            <View style={styles.emptyStateContainer}>
              <Text style={[styles.emptyStateText, { color: colors.textSecondary }]}>No achievements found. Try adjusting your filters or search query.</Text>
            </View>
          ) : (
            <FlatList
        ...
        <Button title="Back" onPress={handleGoBack} variant="outline" style={styles.backButton2} />
      </ScrollView>
      {selectedAchievement && (
        <AchievementModal
